...
def get_args():
    ...
    #
    # CUDA option
    parser.add_argument("--cudas", type=str, required=True,
                        help="Cuda devices in python list")
    # chain options
...
#    raise Exception('Stop here!!!')
    ...
    for iter in range(num_iters):
        ...
        if args.stage <= iter:
            ...
            chain_lib.train_one_iteration2(
                dir=args.dir,
                iter=iter,
                srand=args.srand,
                egs_dir=egs_dir,
                ...
                use_multitask_egs=use_multitask_egs, cudalist=cudalist)
