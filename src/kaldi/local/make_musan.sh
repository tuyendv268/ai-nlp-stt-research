...
grep "vietnamese" ${data_dir}/musan/utt2spk > local/musan.tmp/utt2spk_vietnamese
...
utils/subset_data_dir.sh --utt-list local/musan.tmp/utt2spk_vietnamese \
  ${data_dir}/musan ${data_dir}/musan_vietnamese
...
utils/fix_data_dir.sh ${data_dir}/musan_vietnamese
