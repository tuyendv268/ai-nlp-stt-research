...
train_set=data/mfcc_pitch/ALL-Reading-data-3speed
train_set_mfcchires=data/mfcc_hires/train_3speed_aug
...
ivector=expTDNN2/nnet3/ivectors_train_3speed_aug_max3
...
lats_dir=expmfcc_pitch/tri4_mmi_lats_agu
