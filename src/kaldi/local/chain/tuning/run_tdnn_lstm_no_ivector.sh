...
lat_dir=exp/chain/tri3b_lats # Becarefully
dir=exp/chain/tdnn_lstm
train_data_dir=data/${train_set}
#train_ivector_dir=exp/nnet2_online/ivectors_only
...
echo "stage: $stage ; train_stage:$train_stage; train_set:$train_set; test_sets:$test_sets"
echo "ali_dir:$ali_dir ; lat_dir:$lat_dir"
