...
srcdir=expTDNN2/chain-frt/tdnn_7p
train_data_dir=data/mfcc_hires/FPT-FRT-data-30102018-3wavspeed_Volummed
online_ivector_dir=expTDNN2/nnet3_frt/ivectors_FPT-FRT-data-30102018-3wavspeed_Volummed_max20
...
if [ $stage -le 1 ]; then
  ...
  nj=25 # have a high number of jobs because this could take a while, and we might
