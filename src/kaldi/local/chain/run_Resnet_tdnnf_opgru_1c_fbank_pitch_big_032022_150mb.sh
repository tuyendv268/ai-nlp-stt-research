...
minibatch=${17} # minibatch sizes, like: 256,64
...
if [ $stage -le 3 ]; then
  ...
  conv-relu-batchnorm-layer name=fea_cnn $cnn_opts height-in=11 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128
  
  ### RES-CNN
  conv-relu-batchnorm-layer name=fbank_cnn5 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128
  no-op-component name=cnn_res5 input=Sum(fea_cnn,fbank_cnn5)
  conv-relu-batchnorm-layer name=fbank_cnn6 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128
  no-op-component name=cnn_res6 input=Sum(cnn_res5,fbank_cnn6)
  conv-relu-batchnorm-layer name=fbank_cnn7 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128
  no-op-component name=cnn_res7 input=Sum(cnn_res6,fbank_cnn7)
  conv-relu-batchnorm-layer name=fbank_cnn8 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128
  no-op-component name=cnn_res8 input=Sum(cnn_res7,fbank_cnn8)  
  conv-relu-batchnorm-layer name=fbank_cnn9 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128  
  no-op-component name=cnn_res9 input=Sum(cnn_res8,fbank_cnn9)  
  conv-relu-batchnorm-layer name=fbank_cnn10 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128
  no-op-component name=cnn_res10 input=Sum(cnn_res9,fbank_cnn10)  
  conv-relu-batchnorm-layer name=fbank_cnn11 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128
  no-op-component name=cnn_res11 input=Sum(cnn_res10,fbank_cnn11)  
  conv-relu-batchnorm-layer name=fbank_cnn12 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128 
  no-op-component name=cnn_res12 input=Sum(cnn_res11,fbank_cnn12)  
  conv-relu-batchnorm-layer name=fbank_cnn13 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128  
  no-op-component name=cnn_res13 input=Sum(cnn_res12,fbank_cnn13)
  conv-relu-batchnorm-layer name=fbank_cnn14 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128  
  no-op-component name=cnn_res14 input=Sum(cnn_res13,fbank_cnn14)
  conv-relu-batchnorm-layer name=fbank_cnn15 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=128  
  no-op-component name=cnn_res15 input=Sum(cnn_res14,fbank_cnn15)

  
  relu-batchnorm-layer name=tdnn1 dim=1024
  tdnnf-layer name=tdnnf1 $tdnnf_opts dim=1024 bottleneck-dim=256 time-stride=3
  tdnnf-layer name=tdnnf2 $tdnnf_opts dim=1024 bottleneck-dim=256 time-stride=3
  ...
  norm-opgru-layer name=opgru1 cell-dim=1024 recurrent-projection-dim=512 non-recurrent-projection-dim=512 delay=-3 $gru_opts
  ...
  norm-opgru-layer name=opgru2 cell-dim=1024 recurrent-projection-dim=512 non-recurrent-projection-dim=512 delay=-3 $gru_opts
  ...
  norm-opgru-layer name=opgru3 cell-dim=1024 recurrent-projection-dim=512 non-recurrent-projection-dim=512 delay=-3 $gru_opts
