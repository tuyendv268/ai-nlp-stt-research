...
dir=expTDNN2/chain/cnn_at_tdnn_swb_1a
...
train_set=data/mfcc_pitch/All-140h_cleaned_3speed
train_data_lats=${train_set}
train_set_mfcchires=data/mfcc_hires/All-140h_cleaned_3speed_aug
ali_dir=expmfcc_pitch/tri4_mmi_ali
lang=data/lang_tdnn_nosp
gmm=expmfcc_pitch/tri4_mmi
treedir=expTDNN2/chain/tri4_mmi_tree
ivector=expTDNN2/nnet3/ivectors_All-140h_cleaned_3speed_aug_max3
extractor=expTDNN2/nnet3/extractor
langtrain=data/lang_nosp_tg
lang_test=data/lang_nosp_tg
graph_dir=${dir}/graph_lang_nosp_tg
lats_dir=expmfcc_pitch/tri4_mmi_cleaned_lats_agu
...
if [ $stage -le 12 ]; then
  ...
  attention-relu-renorm-layer name=attention2 num-heads=15 value-dim=80 key-dim=40 num-left-inputs=5 num-right-inputs=2 time-stride=3
  tdnnf-layer name=tdnnf9 $tdnnf_opts dim=1320 bottleneck-dim=160 time-stride=3
  attention-relu-renorm-layer name=attention3 num-heads=15 value-dim=80 key-dim=40 num-left-inputs=5 num-right-inputs=2 time-stride=3
  tdnnf-layer name=tdnnf10 $tdnnf_opts dim=1320 bottleneck-dim=160 time-stride=3
  attention-relu-renorm-layer name=attention4 num-heads=15 value-dim=80 key-dim=40 num-left-inputs=5 num-right-inputs=2 time-stride=3
  tdnnf-layer name=tdnnf11 $tdnnf_opts dim=1320 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf12 $tdnnf_opts dim=1320 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf13 $tdnnf_opts dim=1320 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf14 $tdnnf_opts dim=1320 bottleneck-dim=160 time-stride=3
  tdnnf-layer name=tdnnf15 $tdnnf_opts dim=1320 bottleneck-dim=160 time-stride=3
