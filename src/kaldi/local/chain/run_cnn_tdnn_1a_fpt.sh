...
train_set=data/mfcc_pitch/Kaldi-data-FPT-data-fext-nonoise-20180805
train_data_lats=data/mfcc_pitch/Kaldi-data-FPT-data-fext-nonoise-20180805-sp3ways
train_set_mfcchires=data/mfcc_hires/Kaldi-data-FPT-data-fext-nonoise-20180805_3wavspeed_Volummed
ali_dir=expmfcc_pitch/tri5b_V2_ali
treedir=expTDNN2/chain/tri5b_tree
lang=data/lang_tdnn2
gmm=expmfcc_pitch/tri5b_V2
ivector=expTDNN2/nnet3_cleaned/ivectors_data/mfcc_hires/Kaldi-data-FPT-data-fext-nonoise-20180805_3wavspeed_Volummed_max20
extractor=expTDNN2/nnet3_cleaned/extractor
langtrain=data/lang-training-2018_V1_text6k7Word-Thuoc-En-Fortesting-20180804-vocab_Dict
...
graph_dir=${dir}_online/graph_lang-testing-2018_V1_text6k7Word-Thuoc-En-Fortesting-20180804-AND-3TestSets-TuNgoaiLai-TuDacBiet-20180906.meta.mono-AND-Chat-bot-words-20190906_Dict
lats_dir=expTDNN2/tri5b_lats
...
#  utils/mkgraph.sh --self-loop-scale 1.0 data/lang_sw1_tg $dir $dir/graph_sw1_tg
  ...
  utils/mkgraph.sh --self-loop-scale 1.0 $lang_test ${dir}_online ${graph_dir} || exit 1;
fi
