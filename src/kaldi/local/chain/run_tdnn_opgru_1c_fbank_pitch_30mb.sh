...
if [ $stage -le 3 ]; then
  ...
  relu-batchnorm-layer name=tdnn1 dim=320
  relu-batchnorm-layer name=tdnn2 input=Append(-1,0,1) dim=320
  relu-batchnorm-layer name=tdnn3 input=Append(-1,0,1) dim=320
  # check steps/libs/nnet3/xconfig/gru.py for the other options and defaults
  norm-opgru-layer name=opgru1 cell-dim=320 recurrent-projection-dim=128 non-recurrent-projection-dim=128 delay=-3 $gru_opts
  relu-batchnorm-layer name=tdnn4 input=Append(-3,0,3) dim=320
  relu-batchnorm-layer name=tdnn5 input=Append(-3,0,3) dim=320
  relu-batchnorm-layer name=tdnn6 input=Append(-3,0,3) dim=320
  norm-opgru-layer name=opgru2 cell-dim=320 recurrent-projection-dim=128 non-recurrent-projection-dim=128 delay=-3 $gru_opts
  relu-batchnorm-layer name=tdnn7 input=Append(-3,0,3) dim=320
  relu-batchnorm-layer name=tdnn8 input=Append(-3,0,3) dim=320
  relu-batchnorm-layer name=tdnn9 input=Append(-3,0,3) dim=320
  norm-opgru-layer name=opgru3 cell-dim=320 recurrent-projection-dim=128 non-recurrent-projection-dim=128 delay=-3 $gru_opts
