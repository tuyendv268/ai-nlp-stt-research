...
dir=expTDNN2/chain/cnn_tranformer
...
if [ $stage -le 12 ]; then
  ...
  ### Endcoder (6 layers)
  attention-relu-renorm-layer name=attention2 num-heads=15 value-dim=80 key-dim=40 num-left-inputs=5 num-right-inputs=2 time-stride=0
  attention-relu-renorm-layer name=attention3 num-heads=15 value-dim=80 key-dim=40 num-left-inputs=5 num-right-inputs=2 time-stride=0
  attention-relu-renorm-layer name=attention4 num-heads=15 value-dim=80 key-dim=40 num-left-inputs=5 num-right-inputs=2 time-stride=0
  ### Decoder
  tdnnf-layer name=tdnnf2 $tdnnf_opts input=Append(attention3,attention4) dim=1536 bottleneck-dim=160 time-stride=0
  tdnnf-layer name=tdnnf10 $tdnnf_opts input=Append(attention2,attention3,attention4) dim=1536 bottleneck-dim=160 time-stride=0
  tdnnf-layer name=tdnnf11 $tdnnf_opts input=Append(attention2,attention3,attention4) dim=1536 bottleneck-dim=160 time-stride=0
  tdnnf-layer name=tdnnf12 $tdnnf_opts input=Append(attention2,attention3,attention4) dim=1536 bottleneck-dim=160 time-stride=0
