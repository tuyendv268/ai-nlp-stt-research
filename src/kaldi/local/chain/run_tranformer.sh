...
if [ $stage -le 12 ]; then
  ...
  ### Endcoder (6 layers)
  attention-relu-renorm-layer name=attention7 num-heads=15 value-dim=80 key-dim=40 num-left-inputs=5 num-right-inputs=2 time-stride=3
  attention-relu-renorm-layer name=attention8 num-heads=15 value-dim=80 key-dim=40 num-left-inputs=5 num-right-inputs=2 time-stride=3
  attention-relu-renorm-layer name=attention9 num-heads=15 value-dim=80 key-dim=40 num-left-inputs=5 num-right-inputs=2 time-stride=3
  ### Decoder
  linear-component name=decode1 dim=1536 input=Append(attention7,attention8,attention9)  $linear_opts
  tdnnf-layer name=tdnnf10 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  linear-component name=decode2 dim=1536 input=Append(attention7,attention8,attention9,tdnnf10)  $linear_opts
  tdnnf-layer name=tdnnf11 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=3
  linear-component name=decode3 dim=1536 input=Append(attention7,attention8,attention9,tdnnf11) $linear_opts
