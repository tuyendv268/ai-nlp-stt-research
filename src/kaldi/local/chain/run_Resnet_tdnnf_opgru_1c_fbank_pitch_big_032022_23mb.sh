...
if [ $stage -le 3 ]; then
  ...
  tdnnf-layer name=tdnnf1 $tdnnf_opts dim=256 bottleneck-dim=128 time-stride=3
  tdnnf-layer name=tdnnf2 $tdnnf_opts dim=256 bottleneck-dim=128 time-stride=3
  tdnnf-layer name=tdnnf3 $tdnnf_opts dim=256 bottleneck-dim=128 time-stride=3  
  ...
  tdnnf-layer name=tdnnf4 $tdnnf_opts dim=256 bottleneck-dim=128 time-stride=3
  tdnnf-layer name=tdnnf5 $tdnnf_opts dim=256 bottleneck-dim=128 time-stride=3
