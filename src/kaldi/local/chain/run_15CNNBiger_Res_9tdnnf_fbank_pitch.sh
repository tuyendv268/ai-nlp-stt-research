...
if [ $stage -le 3 ]; then
  ...
  ### RES-CNN
  conv-relu-batchnorm-layer name=mfcc_cnn5 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=96
  no-op-component name=cnn_res5 input=Sum(fea_cnn,mfcc_cnn5)
  conv-relu-batchnorm-layer name=mfcc_cnn6 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=96
  no-op-component name=cnn_res6 input=Sum(cnn_res5,mfcc_cnn6)
  conv-relu-batchnorm-layer name=mfcc_cnn7 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=96
  no-op-component name=cnn_res7 input=Sum(cnn_res6,mfcc_cnn7)
  conv-relu-batchnorm-layer name=mfcc_cnn8 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=96
  no-op-component name=cnn_res8 input=Sum(cnn_res7,mfcc_cnn8)  
  conv-relu-batchnorm-layer name=mfcc_cnn9 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=96  
  no-op-component name=cnn_res9 input=Sum(cnn_res8,mfcc_cnn9)  
  conv-relu-batchnorm-layer name=mfcc_cnn10 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=96
  no-op-component name=cnn_res10 input=Sum(cnn_res9,mfcc_cnn10)  
  conv-relu-batchnorm-layer name=mfcc_cnn11 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=96
  no-op-component name=cnn_res11 input=Sum(cnn_res10,mfcc_cnn11)  
  conv-relu-batchnorm-layer name=mfcc_cnn12 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=96 
  no-op-component name=cnn_res12 input=Sum(cnn_res11,mfcc_cnn12)  
  conv-relu-batchnorm-layer name=mfcc_cnn13 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=96  
  no-op-component name=cnn_res13 input=Sum(cnn_res12,mfcc_cnn13)
  conv-relu-batchnorm-layer name=mfcc_cnn14 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=96  
  no-op-component name=cnn_res14 input=Sum(cnn_res13,mfcc_cnn14)
  conv-relu-batchnorm-layer name=mfcc_cnn15 $cnn_opts height-in=10 height-out=10 time-offsets=-1,0,1 height-offsets=-1,0,1 num-filters-out=96  
