...
dir=expTDNN2/chain/cnn_tdnn_68h_aug9x
...
if [ $stage -le 15 ]; then
  ...
  cnn_opts="l2-regularize=0.01 dropout-proportion=0.0"
  ...
  combine-feature-maps-layer name=combine_inputs $comb_opts input=Append(idct-batchnorm, ivector-batchnorm) num-filters1=1 num-filters2=5 height=40
