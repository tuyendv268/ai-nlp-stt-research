...
ac_model_dir=expTDNN2/chain/tdnn_7p_online
...
dev_text=Preparing-LMs-LSTM/dev.txt
big_text=Preparing-LMs-LSTM/train-all.txt
lexicon=data/local/Testing-Bigdict18k-OnlyBac-XSAMPA/lexicon.txt
text_dir=Preparing-LMs-LSTM
lang=data/lang_nosp_withLM_testing_Testing-Bigdict18k-OnlyBac-XSAMPA_17000_3_5_3gram_pruned_1e-7
...
#  cat "train-all 1 1.0" > $dir/config/data_weights.txt <<EOF
#swbd   3   1.0
#fisher   1   1.0
#EOF
