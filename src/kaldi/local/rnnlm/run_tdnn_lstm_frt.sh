...
ac_model_dir=expTDNN2/chain/tdnn_7p
...
text=/home/huynguyen/2018-Projects/database/FPT-FRT-data-30102018/text
fisher_text=/home/huynguyen/2018-Projects/LMs/20181108-FRT-LMS/Fulldata.v1.txt.gz
lexicon=data/local/2018_V1_text6k7Word-Thuoc-En-Fortesting-20180804-AND-3TestSets-TuNgoaiLai-TuDacBiet-20180906.meta.mono-AND-Chat-bot-words-20190906_Dict/lexiconp.txt
text_dir=expTDNN2/rnnlm/text_nosp_1e
lang=data/lang-testing--OnlyTranscriptLM
mkdir -p $dir/config
set -e
...
if [ $stage -le 1 ]; then
  ...
  echo "<HumanNoise>" >$dir/config/oov.txt
...
EOF
  ...
  rnnlm/choose_features.py --unigram-probs=$dir/config/unigram_probs.txt \
                           ...
                           --special-words='<s>,</s>,<brk>,<HumanNoise>,<Noise>' \
