...
from src.cores.capu.modeling_seq2labels import Seq2LabelsModel
from src.cores.capu.vocabulary import Vocabulary
from src.cores.capu.utils import PAD, UNK, START_TOKEN, get_target_sent_by_edits

logging.getLogger("werkzeug").setLevel(logging.ERROR)
logger = logging.getLogger(__file__)


class CapuBERTModel(torch.nn.Module):
    def __init__(
        self,
        vocab_path=None,
        model_paths=None,
