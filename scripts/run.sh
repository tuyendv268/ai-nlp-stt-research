...
# train_manifest_path="/data/asr-research/data/f88_cleaned_data.jsonl"
# train_manifest_path=[\
# "/data/asr-research/data/f88_cleaned_data.jsonl",\
# "/data/asr-research/tts_data.jsonl",\
# "/data/asr-research/tts_data.jsonl",\
# "/data/asr-research/tts_data.jsonl"\
# ]
...
init_from_nemo_model="/data/ai-nlp-stt-service/exp/ckpts/FastConformer-CTC-BPE-0.1896-veh.nemo"
