...
def main(metadata, pred_metadata_path, batch_size=8):
    ...
    with open(pred_metadata_path, "w") as f:
...
if __name__ == "__main__":        
    filepaths = [
        ...
        "/data/asr/vixtts-demo/cloned_metadata.jsonl",
    ]
    pred_metadata_dir = "/data/asr-research/data/s8_stt_metadata_w2v2_clone"
